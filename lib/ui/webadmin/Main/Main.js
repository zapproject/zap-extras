...
const Address = props => React.createElement("div", {
  className: "address"
}, "Address: ", props.children);

const Provider = props => React.createElement("div", null, props.children ? 'Found provider: ' + props.children : 'This account is currently not setup as a provider');
